...
public class LocacaoServiceTest {
	...
	public void closeMonday() throws Exception {
		...
		Mockito.doReturn(DataUtils.obterData(24, 8, 2017)).when(service).getData();
		...
		Assert.assertThat(dateR, CoreMatchers.is(DataUtils.adicionarDias(new Date(24,7,2017),1)) );
...
//	}
	...
	public void deveCalcularValorLocaco_metodoPrivado() throws Exception {
		...
		Double result = (Double) method.invoke(service, filmes);
